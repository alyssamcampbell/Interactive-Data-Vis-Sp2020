...
function init() {
  ...
  svg
    ...
    .attr("fill", d => {
      ...
      const countryNMR = state.migration.find(e => e.Country === countryName)
      return countryNMR !== undefined ? colorScale(countryNMR['NMR']) : "black"
      console.log(countryNMR)
      // return colorScale(countryNMR)
    })
